 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 5,
   "id": "b319af4c-8605-4dc6-87bd-e1da4173814f",
   "metadata": {},
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "<IPython.lib.display.IFrame at 0x12ac36cab40>"
      ]
     },
     "metadata": {},
   ...
   "source": [
    ...
    "                    [\n",
    "                        html.Div(\n",
    "                            \"Flughafen Basel-Mulhouse-Freiburg: Tägliche Flugbewegungen, Passagiere & Fracht\",\n",
    ...
    "                    style={\"height\": \"20px\"}\n",
    "                ),\n",
    "                html.Span(\"Einstellungen\", className=\"fw-bold text-white\")\n",
    "            ],\n",
    "            className=\"d-flex align-items-center p-3\",\n",
    "            style={\"background-color\": \"rgb(0, 151, 136)\", \"padding\": \"30px\", \"border\": \"2px solid rgb(0, 151, 136)\", \"margin-left\": \"20px\"}\n",
    "        ),\n",
    "        width=3,\n",
    "    ),\n",
    "    dbc.Col(\n",
    ...
    "            [\n",
    "                html.Img(\n",
    "                    src=\"/assets/stats_2.jpg\",\n",
    "                    className=\"me-2 img-fluid\",\n",
    "                    style={\"height\": \"20px\"}\n",
    "                ),\n",
    "                html.Span(\"Visualisierung\", className=\"fw-bold text-white\")\n",
    "            ],\n",
    "            className=\"d-flex align-items-center p-3\",\n",
    "            style={\"background-color\": \"rgb(0, 151, 136)\", \"padding\": \"30px\", \"border\": \"2px solid rgb(0, 151, 136)\",\n",
    "                   \"margin-left\": \"19px\", \"width\": \"97%\"}\n",
    "        ),\n",
    "        width=9,\n",
    "    )\n",
    "])\n",
    ...
    "                    value=[2019, 2020],\n",
    "                    inline=True,\n",
    "                    inputStyle={\"margin-right\": \"5px\"},  # Optionale Anpassung des Abstands\n",
    "                    style={\"color\": \"white\"}\n",
    "                ),\n",
    "                html.Br(),\n",
    ...
    "\n",
    "    df_long = df_filtered.melt(id_vars=['Jahr', 'Monat'], value_vars=value_vars,\n",
    ...
    "            )\n",
    "        ],\n",
    "        margin=dict(l=10, r=200, t=100, b=0),  # Linker Abstand für Verschiebung\n",
    "        title={\"text\": \"Passagierzahlen Juli/August vs. Rest\",\"y\":0.92},  # Verschiebt den Titel nach links\n",
    "        colorway=[\"#87CEEB\", \"#1E90FF\"],  # Farben für das Diagramm\n",
    "       \n",
    "        legend=dict(\n",
    "            y=1.15,  # Erhöht die Position der Legende (nach oben verschieben)\n",
    ...
    "    )\n",
    "    fig.update_layout(\n",
    "       title={\"text\": \"Flugbewegungen pro Monat\", \"y\":0.92},  \n",
    "       margin=dict(l=60, r=40, t=150, b=25),  \n",
    "       legend=dict(\n",
    "           y=1.1,  # Verschiebt die Legende nach oben\n",
    ...
    ")\n",
    "def update_scatter_chart(selected_years, flight_range):\n",
    "    start, end = flight_range  # Die Werte aus dem Range-Slider\n",
    "\n",
    "    # Daten filtern basierend auf den ausgewählten Jahren\n",
    "    df_filtered = df[df['Jahr'].isin(selected_years)].copy()\n",
    "\n",
    "    # Daten weiter filtern basierend auf dem Range-Slider für Flugbewegungen\n",
    "    filtered_scatter = df_filtered[(df_filtered['Flugbewegungen'] >= start) & \n",
    "                                   (df_filtered['Flugbewegungen'] <= end)]\n",
    "\n",
    ...
    "        x='Flugbewegungen',\n",
    "        y='Flugpassagiere',\n",
    "        title='Flugbewegungen und Flugpassagiere',\n",
    "        color='Jahr',\n",
    "        template=\"plotly_dark\"\n",
    "    )\n",
    "\n",
    ...
    "    app.run_server(debug=False, host='127.0.0.1', port=9197)"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "e0d18b99-3b36-4442-954a-65597c9b53d5",
   "metadata": {},
   "outputs": [],
   "source": []
  }
